...
export const FREEMIUM_CONFIG = {
  ...
  // Free tier limits
  FREE_CONNECTIONS_LIMIT: 3,
  FREE_POSTS_PER_CONNECTION: 10,

  // Error messages
  ERRORS: {
    VOICE_THRESHOLD_NOT_MET: 'Voice match score must be at least 50% to use AI features',
    CONNECTION_LIMIT_REACHED: 'Free accounts are limited to 3 connections. Upgrade to create more.',
    GENERATION_LIMIT_REACHED: 'You have used all 10 free generations for this connection. Upgrade to continue.',
  }
};
